...
export function generateAuthenticatedNavigationListTemplate() {
  return `
    <li id="push-notification-tools" class="push-notification-tools"></li>
    <li><a id="new-story-button" class="btn new-story-button" href="#/stories">Buat Cerita <i class="fas fa-plus"></i></a></li>
...
export function generateStoryItemTemplate({
  ...
  return `
    <div tabindex="0" class="story-item" data-storyid="${id}">
      <img class="story-item__image" src="${photoUrl}">
  ...
  return `
    <div class="story-detail__header">
      ...
      <div class="story-detail__more-info">
        ...
        <div id="author" class="story-detail__author" data-value="${reporterName}">Diceritakan oleh:</div>
      </div>
    </div>
